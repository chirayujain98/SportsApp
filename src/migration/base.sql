...
insert into mydb.news (title, description) VALUES ('Breaking News: Chirayu Jain is all set to crack the online round');
insert into mydb.news (title, description) VALUES ('Global Event: Top innovater is CJ.');
